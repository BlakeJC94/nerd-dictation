...
# AIDEV-NOTE: fallback catalog used when the model page cannot be fetched
MODEL_CATALOG_FALLBACK: List[Dict[str, str]] = [
    {"name": "vosk-model-small-en-us-0.15", "lang": "English (US)", "size": "40M", "notes": "Lightweight, recommended for desktop"},
    {"name": "vosk-model-en-us-0.22", "lang": "English (US)", "size": "1.8G", "notes": "Accurate generic US English model"},
    {"name": "vosk-model-en-us-0.22-lgraph", "lang": "English (US)", "size": "128M", "notes": "Big model with dynamic graph"},
    {"name": "vosk-model-en-us-0.42-gigaspeech", "lang": "English (US)", "size": "2.3G", "notes": "Accurate model trained on Gigaspeech"},
    {"name": "vosk-model-small-en-in-0.4", "lang": "English (Indian)", "size": "36M", "notes": "Lightweight Indian English model"},
    {"name": "vosk-model-en-in-0.5", "lang": "English (Indian)", "size": "1G", "notes": "Generic Indian English model"},
    {"name": "vosk-model-small-cn-0.22", "lang": "Chinese", "size": "42M", "notes": "Lightweight model"},
    {"name": "vosk-model-cn-0.22", "lang": "Chinese", "size": "1.3G", "notes": "Big generic Chinese model"},
    {"name": "vosk-model-small-ru-0.22", "lang": "Russian", "size": "45M", "notes": "Lightweight model"},
    {"name": "vosk-model-ru-0.42", "lang": "Russian", "size": "1.8G", "notes": "Big mixed band model"},
    {"name": "vosk-model-small-fr-0.22", "lang": "French", "size": "41M", "notes": "Lightweight model"},
    {"name": "vosk-model-fr-0.22", "lang": "French", "size": "1.4G", "notes": "Big accurate model"},
    {"name": "vosk-model-small-de-0.15", "lang": "German", "size": "45M", "notes": "Lightweight model"},
    {"name": "vosk-model-de-0.21", "lang": "German", "size": "1.9G", "notes": "Big model for telephony and server"},
    {"name": "vosk-model-small-es-0.42", "lang": "Spanish", "size": "39M", "notes": "Lightweight model"},
    {"name": "vosk-model-es-0.42", "lang": "Spanish", "size": "1.4G", "notes": "Big model"},
    {"name": "vosk-model-small-pt-0.3", "lang": "Portuguese", "size": "31M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-it-0.22", "lang": "Italian", "size": "48M", "notes": "Lightweight model"},
    {"name": "vosk-model-it-0.22", "lang": "Italian", "size": "1.2G", "notes": "Big generic Italian model"},
    {"name": "vosk-model-small-nl-0.22", "lang": "Dutch", "size": "39M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-ja-0.22", "lang": "Japanese", "size": "48M", "notes": "Lightweight model"},
    {"name": "vosk-model-ja-0.22", "lang": "Japanese", "size": "1G", "notes": "Big model"},
    {"name": "vosk-model-small-ko-0.22", "lang": "Korean", "size": "82M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-tr-0.3", "lang": "Turkish", "size": "35M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-vn-0.4", "lang": "Vietnamese", "size": "32M", "notes": "Lightweight model"},
    {"name": "vosk-model-vn-0.4", "lang": "Vietnamese", "size": "78M", "notes": "Bigger model"},
    {"name": "vosk-model-small-fa-0.42", "lang": "Farsi", "size": "53M", "notes": "Lightweight model"},
    {"name": "vosk-model-fa-0.42", "lang": "Farsi", "size": "1.6G", "notes": "Big model"},
    {"name": "vosk-model-small-el-gr-0.7", "lang": "Greek", "size": "N/A", "notes": "Big narrowband model (not small despite naming)"},
    {"name": "vosk-model-small-pl-0.22", "lang": "Polish", "size": "50M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-cs-0.4-rhasspy", "lang": "Czech", "size": "44M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-hi-0.22", "lang": "Hindi", "size": "42M", "notes": "Lightweight model"},
    {"name": "vosk-model-hi-0.22", "lang": "Hindi", "size": "1.5G", "notes": "Big model"},
    {"name": "vosk-model-small-uk-v3-nano", "lang": "Ukrainian", "size": "73M", "notes": "Nano model"},
    {"name": "vosk-model-uk-v3", "lang": "Ukrainian", "size": "343M", "notes": "Bigger model"},
    {"name": "vosk-model-small-sv-rhasspy-0.15", "lang": "Swedish", "size": "289M", "notes": "Repackaged Rhasspy model"},
    {"name": "vosk-model-small-eo-0.42", "lang": "Esperanto", "size": "42M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-ar-tn-0.1-linto", "lang": "Arabic (Tunisian)", "size": "158M", "notes": "Small model from Linagora"},
    {"name": "vosk-model-ar-mgb2-0.4", "lang": "Arabic", "size": "318M", "notes": "Repackaged MGB2 model"},
    {"name": "vosk-model-small-ca-0.4", "lang": "Catalan", "size": "42M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-uz-0.22", "lang": "Uzbek", "size": "49M", "notes": "Lightweight model"},
    {"name": "vosk-model-small-kz-0.42", "lang": "Kazakh", "size": "58M", "notes": "Small mobile model"},
    {"name": "vosk-model-kz-0.42", "lang": "Kazakh", "size": "1.3G", "notes": "Bigger model"},
    {"name": "vosk-model-small-gu-0.42", "lang": "Gujarati", "size": "100M", "notes": "Lightweight model"},
    {"name": "vosk-model-gu-0.42", "lang": "Gujarati", "size": "700M", "notes": "Big model"},
    {"name": "vosk-model-small-te-0.42", "lang": "Telugu", "size": "58M", "notes": "Lightweight model"},
    {"name": "vosk-model-br-0.8", "lang": "Breton", "size": "70M", "notes": "Breton model"},
]


def _fetch_model_catalog() -> Optional[List[Dict[str, str]]]:
    import re

    try:
        with urllib.request.urlopen(VOSK_MODELS_URL, timeout=10) as resp:
    ...
    for row_match in re.finditer(r"<tr>(.*?)</tr>", html, re.DOTALL):
        ...
        # Language header rows contain <strong> tags and no links
        strong_match = re.search(r"<strong>(.*?)</strong>", first_cell)
        link_match = re.search(r'<a\s+href="([^"]+)">(.*?)</a>', first_cell)

        if strong_match and not link_match:
            current_lang = re.sub(r"<.*?>", "", strong_match.group(1)).strip()
            continue

        if not link_match or len(cells) < 2:
            continue

        model_name = re.sub(r"<.*?>", "", link_match.group(2)).strip()
        model_url = link_match.group(1).strip()
        size = re.sub(r"<.*?>", "", cells[1]).strip()
        notes = re.sub(r"<.*?>", "", cells[3]).strip() if len(cells) > 3 else ""
...
def _get_model_catalog(verbose: int = 0) -> List[Dict[str, str]]:
    if verbose >= 1:
        sys.stderr.write("Fetching model list from " + VOSK_MODELS_URL + " ...\n")
    fetched = _fetch_model_catalog()
    if fetched is not None:
        return fetched
    sys.stderr.write("Could not fetch model list, using built-in catalog.\n")
...
def main_download_model(
    *,
    ...
    if list_only:
        ...
        print("  {:<4s} {:<35s} {:<20s} {:<8s} {}".format("#", "Model", "Language", "Size", "Notes"))
        print("  " + "-" * 95)
        for i, m in enumerate(catalog, 1):
            print("  {:<4d} {:<35s} {:<20s} {:<8s} {}".format(i, m["name"], m["lang"], m["size"], m["notes"]))
        print("\nFor more models see: " + VOSK_MODELS_URL)
        return
    ...
    if not model_name:
        ...
        while True:
            choice = input("Enter model number to download (or 'q' to quit): ").strip()
            if choice.lower() == "q":
                return
            try:
                idx = int(choice) - 1
            ...
            if idx < 0 or idx >= len(catalog):
                print("Number out of range. Choose 1-{}.".format(len(catalog)))
                continue
            break
        model_entry = catalog[idx]
    else:
        matches = [m for m in catalog if m["name"] == model_name]
        if not matches:
            sys.stderr.write("Unknown model: {!r}\n".format(model_name))
            sys.stderr.write("Use --list to see available models.\n")
            sys.exit(1)
        model_entry = matches[0]

    model_name = model_entry["name"]
    model_url = model_entry.get("url", VOSK_MODELS_URL + "/" + model_name + ".zip")

    if not vosk_model_dir:
        vosk_model_dir = calc_user_config_path("model")

    dest_dir = os.path.dirname(vosk_model_dir)
    if not os.path.isdir(dest_dir):
        os.makedirs(dest_dir, exist_ok=True)

    # AIDEV-NOTE: if a model directory already exists, back it up rather than overwrite
    if os.path.exists(vosk_model_dir):
        backup = vosk_model_dir + ".old"
        if os.path.exists(backup):
            shutil.rmtree(backup)
        shutil.move(vosk_model_dir, backup)
        print("Existing model backed up to: " + backup)

    print("Downloading " + model_name + "...")
    print("  URL: " + model_url)

    tmp_zip = os.path.join(tempfile.gettempdir(), model_name + ".zip")
    try:
        urllib.request.urlretrieve(model_url, tmp_zip)
    except Exception as ex:
        sys.stderr.write("Download failed: {!s}\n".format(ex))
        file_remove_if_exists(tmp_zip)
        sys.exit(1)

    print("Extracting...")
    try:
        with zipfile.ZipFile(tmp_zip, "r") as zf:
            extract_dir = os.path.dirname(vosk_model_dir) if os.path.dirname(vosk_model_dir) else "."
    ...
    # The zip extracts as e.g. "vosk-model-small-en-us-0.15/", rename to expected path.
    extracted_path = os.path.join(os.path.dirname(vosk_model_dir) or ".", model_name)
    if os.path.exists(extracted_path) and extracted_path != vosk_model_dir:
        if os.path.exists(vosk_model_dir):
            shutil.rmtree(vosk_model_dir)
        shutil.move(extracted_path, vosk_model_dir)

    print("Model installed to: " + vosk_model_dir)
...
def argparse_create_download_model(subparsers: "argparse._SubParsersAction[argparse.ArgumentParser]") -> None:
    subparse = subparsers.add_parser(
        "download-model",
        help="Download a VOSK speech recognition model.",
        description=(
            "Download a VOSK speech recognition model.\n"
            "\n"
            "Run without arguments to see available models and choose interactively.\n"
            "Use --list to print the model table without downloading."
        ),
        formatter_class=argparse.RawTextHelpFormatter,
    )
    ...
    subparse.add_argument(
        ...
        metavar="MODEL_NAME",
        help=(
            "Name of the model to download (e.g. vosk-model-small-en-us-0.15).\n"
            "If omitted, an interactive list is presented."
        ),
        required=False,
    )
    ...
    subparse.add_argument(
        ...
        type=str,
        metavar="DIR",
        help="Path to install the model to. Defaults to ~/.config/nerd-dictation/model.",
        required=False,
    )
    ...
    subparse.set_defaults(
        func=lambda args: main_download_model(
...
def argparse_create() -> argparse.ArgumentParser:
    ...
    argparse_create_download_model(subparsers)
